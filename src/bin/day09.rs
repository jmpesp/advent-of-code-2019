...
fn main() {
    let contents =
        fs::read_to_string("day9.input").expect("Something went wrong reading the file!");
    ...
    // part 1
    //run_intcode_computer_and_print(numbers, 1);

    // part 2
    run_intcode_computer_and_print(numbers, 2);
}
